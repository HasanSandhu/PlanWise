...
export function TaskFormScreen({
  ...
  const styles = StyleSheet.create({
    ...
    details: { color: palette.gray, fontSize: 12 },
    progressTrack: {
      width: 245,
      height: 7,
      borderRadius: 5,
      backgroundColor: darkMode ? "#2A3A4E" : "#ECE9E9",
      marginTop: 10,
    },
    progressFill: {
      width: "66%",
    ...
    input: {
      height: 50,
      borderWidth: 1.5,
      borderColor: darkMode ? "#3A4C5F" : "#C9CFD8",
      borderRadius: 9,
    ...
    category: {
      ...
      paddingHorizontal: 15,
      borderRadius: 12,
      backgroundColor: darkMode ? "#243243" : "#E9E6E6",
      flexDirection: "row",
      alignItems: "center",
      gap: 6,
    },
    categoryActive: { backgroundColor: palette.blue },
    categoryText: { color: palette.text, fontSize: 15 },
    ...
    inputInner: { flex: 1, fontSize: 15, color: palette.ink },
    priorityRow: {
      flexDirection: "row",
      backgroundColor: darkMode ? "#202D3D" : "#EEEAEA",
      borderRadius: 8,
      overflow: "hidden",
    },
    priority: {
    ...
    priorityText: { color: palette.text, fontSize: 15 },
    ...
    cancel: {
      ...
      borderRadius: 8,
      borderWidth: 1,
      borderColor: darkMode ? "#44576A" : "#CDD1D8",
      alignItems: "center",
      justifyContent: "center",
    },
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Fill in the essentials to keep your momentum going.
        </Text>
        ...
        <TextInput
          ...
          placeholderTextColor={darkMode ? "#8A98A8" : "#A7B1BD"}
          style={styles.input}
        />
          ...
          {categories.map((item) => (
            ...
            >
              <Ionicons
                ...
                size={17}
                color={category === item.value ? "white" : palette.text}
              />
              <Text
                style={[
                  styles.categoryText,
                  category === item.value && styles.activeText,
                ]}
              >
                {item.label}
              </Text>
        ...
        <View style={styles.actions}>
          ...
          <Pressable
            onPress={save}
            style={[styles.save, !title.trim() && { opacity: 0.5 }]}
          >
